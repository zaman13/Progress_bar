...
Nblock = 15;       # number of blocks in the bar plot
...
for i = 1:max_count
    ...
    sleep(0.1);          # delay loop. sleep() command may cause some unexpected issues.
                         # note that the sleep() function doesn't cause any problem here.
                         # However, if it is used in Jupyter notebook, it doesn't work
                         # correctly.
end
